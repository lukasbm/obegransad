...
#define P_LATCH CONFIG_MY_DISPLAY_LATCH_PIN // LA/ (active‑low latch); STCP LATCH
#define P_CLK CONFIG_MY_DISPLAY_CLK_PIN     // shift clock; SPI-SCK
#define P_DI CONFIG_MY_DISPLAY_DI_PIN       // serial data into SCT2024 SDI; SPI-MOSI
#define P_OE CONFIG_MY_DISPLAY_OE_PIN       // OE/ (active‑low output enable)
